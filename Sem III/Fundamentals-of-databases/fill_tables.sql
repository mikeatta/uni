...
INSERT ALL
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (1, 1, 'Honda', 'Accord', 2022, 'ABC123', 96000.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (2, 2, 'Ford', 'Focus', 2016, 'DEF890', 44000.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (3, 7, 'Audi', 'A4', 2020, 'ZXY456', 56000.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (4, 6, 'Nissan', 'Altima', 2019, 'UWZ113', 47600.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (5, 9, 'Fiat', '500', 2017, 'XXS137', 28000.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (6, 10, 'Mazda', 'CX-5', 2018, 'MZD654', 74600.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (7, 10, 'Mazda', 'MX-5', 2021, 'MDA665', 160900.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (8, 4, 'Hyundai', 'Veloster', 2017, '345VST', 102800.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (9, 12, 'Volvo', 'XC90', 2022, 'VLVX90', 220000.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (10, 12, 'VOlvo', 'V90', 2013, 'VLVV90', 70000.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (11, 13, 'Subaru', 'Impreza', 2007, 'SBRU07', 63000.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (12, 8, 'Kia', 'Stinger', 2018, 'STGR18', 133000.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (13, 14, 'Chrysler', 'PT-Cruiser', 2006, 'PTCR06', 17000.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (14, 5, 'Mercedes-Benz', 'G Class', 2023, 'GKLS63', 1340000.00)
    INTO Samochod (SamochodID, ProducentID, Marka, Model, Rocznik, VIN, Cena) VALUES (15, 15, 'Mitsuoka', 'Orochi', 2013, 'MIT013', 560000.00)
SELECT * FROM dual;

-- Insert 15 entries into Options
INSERT ALL
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (1, 'Nawigacja', 3000.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (2, 'Ładowarka bezprzewodowa', 1200.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (3, 'Kamera cofania', 1500.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (4, 'Czujniki cofania', 1000.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (5, 'System monitorowania ślepego punktu', 6600.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (6, 'Asystent parkowania', 8800.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (7, 'System bezkluczykowy', 5000.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (8, 'System monitorowania toru jazdy', 33400.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (9, 'Podgrzewane siedzenia', 11200.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (10, 'Podgrzewana kierownica', 4800.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (11, 'Nagłośnienie premium', 10500.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (12, 'Panoramiczny dach', 22600.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (13, 'Opony zimowe', 12400.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (14, 'Bagażnik na dach', 3300.00)
    INTO Opcje (OpcjaID, Nazwa, Cena) VALUES (15, 'Uchwyt na rowery', 1600.00)
SELECT * FROM dual;
...
INSERT ALL
    ...
    INTO Rabat (TransakcjaID, KlientID, Kwota, Procent, Rodzaj) VALUES (6, 10, 125.00, NULL, 'Kwota')
    INTO Rabat (TransakcjaID, KlientID, Kwota, Procent, Rodzaj) VALUES (7, 5, 300.00, NULL, 'Kwota')
    INTO Rabat (TransakcjaID, KlientID, Kwota, Procent, Rodzaj) VALUES (10, 6, 150.00, NULL, 'Kwota')
...
INSERT ALL
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (1, 1, 1340000.00, date'2023-04-10')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (2, 2, 450.00, date'2023-05-13')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (3, 3, 560000.00, date'2023-06-15')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (4, 4, 350.00, date'2023-07-17')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (5, 5, 1200.00, date'2023-08-22')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (6, 6, 1200.00, date'2023-09-28')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (7, 7, 1200.00, date'2023-10-30')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (8, 8, 1000.00, date'2023-11-06')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (9, 9, 1200.00, date'2023-12-11')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (10, 10, 96000.00, date'2024-01-17')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (11, 11, 760.00, date'2024-02-23')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (12, 12, 1300.00, date'2024-03-27')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (13, 13, 3300.00, date'2024-04-30')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (14, 14, 14200.00, date'2024-05-09')
    INTO Platnosc (PlatnoscID, TransakcjaID, Wartosc, Data) VALUES (15, 15, 44000.00, date'2024-06-12')
SELECT * FROM dual;

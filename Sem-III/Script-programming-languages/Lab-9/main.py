...
# Exc 8 - Sum matrix & count occurrences
def sum_and_count_matrix():
    print("Exc 8 - Sum elements and count occurrences")
    ...
    for occurrence in range(10):
        print(f"[{str(occurrence)}] : {str(np.count_nonzero(matrix == occurrence))}")
...
def main():
    ...
    sum_and_count_matrix() # Exc 8 - Sum elements and count occurrences
